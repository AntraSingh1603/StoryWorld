...

    {
      ...
      pages: [
        ...
        // -------- EXTRA STORIES START --------
        {
          ...
          description: "A puppy finds its way home.",
          ageGroup: "3-5",
          readingLevel: "beginner",
          genre: "adventure",
          coverEmoji: "🐶",
          ...
          isFeatured: true,
          pages: [
            { pageNumber: 1, text: "A puppy got lost...", backgroundEmoji: "🌳", characters: ["🐶"] },
            { pageNumber: 2, text: "It found its home.", backgroundEmoji: "🏡", characters: ["🐶"] }
          ]
        },

        {
          title: "The Flying Book",
          description: "A magical book that flies.",
          ageGroup: "6-9",
          readingLevel: "intermediate",
          genre: "fantasy",
          coverEmoji: "📖",
          coverColor: "#8e44ad",
          moral: "Books are magical.",
          isFeatured: true,
          pages: [
            { pageNumber: 1, text: "A book started flying...", backgroundEmoji: "✨", characters: ["📖"] },
            { pageNumber: 2, text: "It took kids to adventure.", backgroundEmoji: "🌍", characters: ["📖"] }
          ]
        },

        {
          title: "The Happy Tree",
          description: "A tree that gives fruits happily.",
          ageGroup: "3-5",
          readingLevel: "beginner",
          genre: "nature",
          coverEmoji: "🌳",
          coverColor: "#27ae60",
          moral: "Giving is happiness.",
          isFeatured: false,
          pages: [
            { pageNumber: 1, text: "A tree gave fruits...", backgroundEmoji: "🌿", characters: ["🌳"] },
            { pageNumber: 2, text: "Everyone loved it.", backgroundEmoji: "🍎", characters: ["🌳"] }
          ]
        },

        {
          title: "Space Boy",
          description: "A boy travels space.",
          ageGroup: "7-10",
          readingLevel: "advanced",
          genre: "science",
          coverEmoji: "🚀",
          ...
          isFeatured: false,
          pages: [
            { pageNumber: 1, text: "A boy went to space...", backgroundEmoji: "🌌", characters: ["🧒"] },
            { pageNumber: 2, text: "He saw planets.", backgroundEmoji: "🪐", characters: ["🧒"] }
          ]
        },

        {
          title: "The Kind Elephant",
          description: "An elephant helps others.",
          ageGroup: "4-7",
          readingLevel: "beginner",
          genre: "nature",
          coverEmoji: "🐘",
          ...
          isFeatured: false,
          pages: [
            { pageNumber: 1, text: "An elephant helped friends...", backgroundEmoji: "🌳", characters: ["🐘"] },
            { pageNumber: 2, text: "Everyone loved him.", backgroundEmoji: "❤️", characters: ["🐘"] }
          ]
        },

        // ADD MORE SIMPLE STORIES (SHORT FORMAT)
        {
          title: "The Fast Rabbit",
          description: "A rabbit learns patience.",
          ageGroup: "3-5",
          readingLevel: "beginner",
          genre: "adventure",
          coverEmoji: "🐰",
          ...
          isFeatured: false,
          pages: [
            { pageNumber: 1, text: "A fast rabbit ran...", backgroundEmoji: "🏃", characters: ["🐰"] },
            { pageNumber: 2, text: "It learned patience.", backgroundEmoji: "🌿", characters: ["🐰"] }
          ]
        },

        {
          title: "Magic Shoes",
          description: "Shoes that can fly.",
          ageGroup: "6-9",
          readingLevel: "intermediate",
          genre: "fantasy",
          coverEmoji: "👟",
          ...
          isFeatured: false,
          pages: [
            { pageNumber: 1, text: "Shoes started flying...", backgroundEmoji: "✨", characters: ["👟"] },
            { pageNumber: 2, text: "Boy enjoyed journey.", backgroundEmoji: "🌍", characters: ["👟"] }
          ]
        },

        {
          title: "Ocean Adventure",
          description: "A deep sea journey.",
          ageGroup: "4-7",
          readingLevel: "beginner",
          genre: "nature",
          coverEmoji: "🌊",
          coverColor: "#3498db",
          moral: "Explore nature.",
          isFeatured: false,
          pages: [
            { pageNumber: 1, text: "A fish explored ocean...", backgroundEmoji: "🐠", characters: ["🐠"] },
            { pageNumber: 2, text: "It found treasures.", backgroundEmoji: "💎", characters: ["🐠"] }
          ]
        },

        {
          title: "Robot Friend",
          description: "A robot becomes friend.",
          ageGroup: "7-10",
          readingLevel: "advanced",
          genre: "science",
          coverEmoji: "🤖",
          coverColor: "#34495e",
          moral: "Friendship matters.",
          isFeatured: false,
          pages: [
            { pageNumber: 1, text: "A robot was alone...", backgroundEmoji: "🤖", characters: ["🤖"] },
            { pageNumber: 2, text: "He found a friend.", backgroundEmoji: "❤️", characters: ["🤖"] }
          ]
        },

        {
          title: "The Singing Bird",
          description: "A bird sings happily.",
          ageGroup: "3-5",
          readingLevel: "beginner",
          genre: "nature",
          coverEmoji: "🐦",
          ...
          isFeatured: false,
          pages: [
            { pageNumber: 1, text: "A bird sang songs...", backgroundEmoji: "🎵", characters: ["🐦"] },
            { pageNumber: 2, text: "Everyone smiled.", backgroundEmoji: "😊", characters: ["🐦"] }
          ]
        }
        // -------- EXTRA STORIES END --------
